...
```mermaid
flowchart TD
    A[Start Game] --> B[Welcome Screen]
    B --> C[Mission Setup]
    C --> D[Mission Briefing]
    D --> E[Gameplay Screen]
    E --> F[Player Enters Coordinate]
    F --> G{Valid Input?}
    G -- No --> H[Show Validation Message]
    H --> E
    G -- Yes --> I[Resolve Player Shot]
    I --> J{Enemy Fleet Destroyed?}
    J -- Yes --> K[Mission Accomplished Screen]
    J -- No --> L[Enemy Turn]
    L --> M{Player Fleet Destroyed?}
    M -- Yes --> N[Mission Failed Screen]
    M -- No --> E
```
...
![Mission Setup Screen](docs/images/mission-setup-screen.png)
...
![Mission Briefing Screen](docs/images/mission-briefing-screen.png)
...
![Gameplay Screen](docs/images/gameplay-screen.png)
...
![Turn Feedback Screen](docs/images/turn-feedback-screen.png)
...
![Mission Accomplished Screen](docs/images/mission-accomplished-screen.png)

![Mission Failed Screen](docs/images/mission-failed-screen.png)
